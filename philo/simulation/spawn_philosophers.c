...
/*   Updated: 2024/07/19 06:55:07 by tischmid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
static
t_philo	**_prepare_philo_spawning(
	t_params *params,
	t_fork **first_fork,
	t_philo **first_philo
)
...
)
{
	...
	while (TRUE)
	{
		...
		{
			(void)cleanup_philos(philos, params);
			return (NULL);
		}
		++idx;
